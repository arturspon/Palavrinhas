<template>
  <div>
    ...
    <p>
      Artur Sponchiado is committed to ensuring that the app is as useful and
    ...
    <p>
      The Palavrinhas app stores and processes personal data that you have
      ...
      features and it could mean that the Palavrinhas app won’t work properly or
      at all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Artur Sponchiado
      ...
      be Wi-Fi or provided by your mobile network provider, but Artur Sponchiado
    ...
    <p>
      Along the same lines, Artur Sponchiado cannot always take responsibility
      ...
      avail the Service, Artur Sponchiado cannot accept responsibility.
    </p>
    <p>
      With respect to Artur Sponchiado’s responsibility for your use of the app,
      ...
      available to you. Artur Sponchiado accepts no liability for any loss,
    ...
    <p>
      ...
      the app. Artur Sponchiado does not promise that it will always update the
    ...
    <p>These terms and conditions are effective as of 2022-03-15</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about my Terms and Conditions, do
      not hesitate to contact me at artursponchi@gmail.com.
    </p>
    <p>
